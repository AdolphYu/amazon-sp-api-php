...
class Fee implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'name' => 'string',
'amount' => '\AdolphYu\AmazonSellingPartnerAPI\Models\FulfillmentOutbound\Money',    ];
...
self::NAME_FBA_FULFILLMENT_COD_FEE,        ];
     ...
     * Sets amount.
     *
     * @param \AdolphYu\AmazonSellingPartnerAPI\Models\FulfillmentOutbound\Money $amount amount
     *
     * @return $this
     */
