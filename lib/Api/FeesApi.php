...
class FeesApi
{
     ...
     *
     * @param \AdolphYu\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateRequest $body body (required)
     * @param string                                                                        $asin The Amazon Standard Identification Number (ASIN) of the item. (required)
     *
     * @throws \InvalidArgumentException
     * @throws \AdolphYu\AmazonSellingPartnerAPI\ApiException on non-2xx response
     *
     * @return \AdolphYu\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateResponse
     */
     ...
     *
     * @param \AdolphYu\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateRequest $body (required)
     * @param string                                                                        $asin The Amazon Standard Identification Number (ASIN) of the item. (required)
     *
     * @throws \InvalidArgumentException
     * @throws \AdolphYu\AmazonSellingPartnerAPI\ApiException on non-2xx response
     *
     * @return array of \AdolphYu\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateResponse, HTTP status code, HTTP response headers (array of strings)
     */
