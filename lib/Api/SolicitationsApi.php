...
use AdolphYu\AmazonSellingPartnerAPI\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse;
use AdolphYu\AmazonSellingPartnerAPI\Models\Solicitations\GetSolicitationActionsForOrderResponse;
...
class SolicitationsApi
{
     ...
     *
     * @return \AdolphYu\AmazonSellingPartnerAPI\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse
     */
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \AdolphYu\AmazonSellingPartnerAPI\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\AdolphYu\AmazonSellingPartnerAPI\Models\Solicitations\CreateProductReviewAndSellerFeedbackSolicitationResponse';
        $request = $this->createProductReviewAndSellerFeedbackSolicitationRequest($amazon_order_id, $marketplace_ids);
     ...
     * @throws \InvalidArgumentException
     *
     * @return \AdolphYu\AmazonSellingPartnerAPI\Models\Solicitations\GetSolicitationActionsForOrderResponse
     */
     ...
     * @throws \InvalidArgumentException
     *
     * @return array of \AdolphYu\AmazonSellingPartnerAPI\Models\Solicitations\GetSolicitationActionsForOrderResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\AdolphYu\AmazonSellingPartnerAPI\Models\Solicitations\GetSolicitationActionsForOrderResponse';
        $request = $this->getSolicitationActionsForOrderRequest($amazon_order_id, $marketplace_ids);
