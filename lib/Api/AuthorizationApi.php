...
use AdolphYu\AmazonSellingPartnerAPI\Models\Authorization\GetAuthorizationCodeResponse;
...
class AuthorizationApi
{
     ...
     * @throws ApiException             on non-2xx response
     *
     * @return array of \AdolphYu\AmazonSellingPartnerAPI\Models\Authorization\GetAuthorizationCodeResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAuthorizationCodeWithHttpInfo($selling_partner_id, $developer_id, $mws_auth_token)
    {
        $returnType = '\AdolphYu\AmazonSellingPartnerAPI\Models\Authorization\GetAuthorizationCodeResponse';
